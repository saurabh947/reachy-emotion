...
echo "         EMOTION_CLOUD_ENDPOINT  — GKE LoadBalancer IP:port (e.g. 34.x.x.x:50051)"
echo "         (get the IP: kubectl get svc emotion-cloud-grpc -o jsonpath='{.status.loadBalancer.ingress[0].ip}')"
